...
/* Login to Online_Food_Ordering_System 
*/

describe('My Login application', async() => {

    it('should login with valid credentials by using Keys_Actions', async () => {
        ...
        await browser.keys([Key.Tab,'Tab','Tab','Tab',Key.Enter]);
        await browser.pause(2000);
        await browser.keys([Key.Tab,'Tab','Tab','Tab','Tab','Tab','ahmedrazakhan412@gmail.com']);
        await browser.keys([Key.Tab,'khan@412']);
    ...
    it('should select Dish with Restaurants and view Menu', async () => {
        await browser.keys([Key.Tab,'Tab','Tab',Key.Enter]);
        await browser.pause(2000);
        await browser.keys(['Tab','Tab','Tab','Tab','Tab','Tab','Tab','Tab','Tab','Tab','Tab',Key.Enter]);
        await browser.pause(3000);
    })
